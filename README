...
Tested with PyTorch `1.11.0` - `2.1.2` and their respective compute platforms and supported OSes, with an exception for `cu102` on Windows (no VS 2017 on GH `windows-2019` runner), and the `rocm` platform.
